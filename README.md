...
- **Interaktives Web-Dashboard (`index.html`)**: Generiert automatisch eine moderne dunkle Vorschau-Galerie im Browser pro Projekt.
...
```
OutputFolder/
└── 📁 <InputFileName>/       # Separater Ordner für jede Eingabedatei
    ...
    │   ├── 📄 animations_data.js # Animationsdaten (Matrizen & Frames)
